...
(function(a, b) {
  ...
  (function(a, b, c) {
    ...
    b.AnimationTimeline.prototype = {
      ...
      getAnimationPlayers: function() {
        a.deprecated("AnimationTimeline.getAnimationPlayers", "2015-03-23", "Use AnimationTimeline.getAnimations instead.");
  ...
  (function(a, b, c) {
    ...
    b.Animation.prototype = {
      ...
      get source() {
        a.deprecated("Animation.source", "2015-03-23", "Use Animation.effect instead.");
        return this.effect;
      },
      play: function() {
        this._updatePromises();
  ...
  (function(a, b, c) {
    ...
    b.KeyframeEffect.prototype = {
      ...
      get effect() {
        a.deprecated("KeyframeEffect.effect", "2015-03-23", "Use KeyframeEffect.getFrames() instead.");
        return this._normalizedKeyframes;
      },
      clone: function() {
    ...
    window.Element.prototype.getAnimationPlayers = function() {
      a.deprecated("Element.getAnimationPlayers", "2015-03-23", "Use Element.getAnimations instead.");
      return this.getAnimations();
    };
    window.Animation = function() {
      a.deprecated("window.Animation", "2015-03-23", "Use window.KeyframeEffect instead.");
  ...
  (function(a, b, c) {
    ...
    b.bindAnimationForCustomEffect = function(b) {
      ...
      var d = b.effect._normalizedKeyframes;
      var f = b.effect.timing;
      var g = null;
      f = a.normalizeTimingInput(f);
      var i = function() {
        var e = i._animation ? i._animation.currentTime : null;
        if (null !== e) {
          e = a.calculateTimeFraction(a.calculateActiveDuration(f), e, f);
          if (isNaN(e)) {
            e = null;
          }
        }
  ...
  (function(a, b, c) {
    ...
    function e(b, c) {
      ...
      this.timing = a.makeTiming(c, true);
    ...
    b.newUnderlyingAnimationForGroup = function(c) {
      ...
      d = b.timeline._play(new b.KeyframeEffect(null, f, c._timing));
      return d;
    };
    ...
    window.AnimationSequence = function() {
      a.deprecated("window.AnimationSequence", "2015-03-23", "Use window.SequenceEffect instead.");
    ...
    window.AnimationGroup = function() {
      a.deprecated("window.AnimationGroup", "2015-03-23", "Use window.GroupEffect instead.");
